...
public class Game implements ApplicationListener {
    ...
    public void create() {        
        ...
        /*for(IGamePluginService instance : SPILocator.locateAll(IGamePluginService.class)){
    ...
    private void update() {
        ...
        for(IEntityProcessingService instance : SPILocator.locateAll(IEntityProcessingService.class)){
